...
def _create_numpy_blob(size: Tuple[int, int], center: Tuple[int, int], radius: float, spacing: float,
...
def one_blob():
    ...
    numpy_blob = _create_numpy_blob(size=(100, 100), center=(25,50), radius=1.0, spacing=0.5, intensity=255)
...
def two_blobs():
    ...
    blob1 = _create_numpy_blob(size=(100,100), radius=1.5, spacing=1.1, center=(25,50), intensity=255)
    blob2 = _create_numpy_blob(size=(100,100), radius=1.5, spacing=1.1, center=(50,75), intensity=155)
...
def six_small_blobs_one_big_blob():
    big_blob = _create_numpy_blob(size=(200,200), spacing=1.1, radius=6, center=(100,100), intensity=255)
    small_blob_locations = [(25, 50), (25, 100), (25, 150), (175, 50), (175, 100), (175, 150)]
    small_blob_radii = [1.1, 1.5, 2.0, 2.5, 1.4, 2.2]
    
    for loc, radius in zip(small_blob_locations, small_blob_radii):
        big_blob += _create_numpy_blob(size=(200,200), spacing=1.1, intensity=125, center=loc, radius=radius)
